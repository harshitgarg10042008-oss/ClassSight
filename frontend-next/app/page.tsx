...
type ReviewRecord = { recordId: number; studentId: number; studentName: string; rollNumber: string; status: string; confidenceScore?: number; qualityWarning?: string };
type Review = { sessionId: number; status: string; records: ReviewRecord[]; capturedPhotoPath?: string; photoUrl: string; quality?: { qualityPassed?: boolean; warning?: string; blurScore?: number; brightnessMean?: number } };
